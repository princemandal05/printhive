...
export default async function BuyerDashboard() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    primaryBtn: { background: 'linear-gradient(135deg, #FF6B35 0%, #F97316 100%)', color: '#fff', padding: '10px 18px', borderRadius: 10, fontWeight: 800, fontSize: 13, textDecoration: 'none', boxShadow: '0 4px 14px rgba(255,107,53,0.25)', display: 'inline-flex', alignItems: 'center', gap: 6 },
    ...
    actionCard: { background: '#FFFFFF', borderRadius: 14, border: '1px solid #E2E8F0', padding: 18, textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center', gap: 14, transition: 'all 0.2s' },
  }
      ...
      <main style={s.main}>
        ...
        <div style={s.headerRow}>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <Link href="/print-on-demand" style={{ background: '#FFFFFF', color: '#0F172A', border: '1px solid #CBD5E1', padding: '10px 18px', borderRadius: 10, fontWeight: 700, fontSize: 13, textDecoration: 'none' }}>
