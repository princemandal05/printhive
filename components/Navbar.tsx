...
const DASHBOARD_PATH: Record<string, string> = {
  ...
  vendor: ROUTES.seller.dashboard,
...
const ROLE_NAV_LINKS: Record<string, { href: string; label: string }[]> = {
  public: [
    ...
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.printOnDemand, label: 'Print File' },
    { href: ROUTES.requests, label: 'Custom Design' },
  ],
  buyer: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.printOnDemand, label: 'Print File' },
    { href: ROUTES.requests, label: 'Custom 3D' },
  ],
  seller: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.seller.newProduct, label: '+ Add Product' },
  ],
  vendor: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.seller.dashboard, label: 'Seller Dashboard' },
  ],
  designer: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.requests, label: 'Client Briefs' },
    { href: ROUTES.designer.upload, label: '+ Upload Model' },
  ],
  printer_owner: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.printers, label: 'Nearby Hubs' },
    { href: ROUTES.requests, label: 'Print Briefs' },
  ],
  printer: [
    { href: ROUTES.home, label: 'Home' },
    { href: ROUTES.shop, label: 'Shop' },
  ...
  admin: [
    ...
    { href: ROUTES.shop, label: 'Shop' },
    { href: ROUTES.browse, label: '3D Models' },
    { href: ROUTES.printers, label: 'Hubs' },
