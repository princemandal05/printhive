-- ==============================================================================
-- PrintHive Supabase Advisor Security Remediation Migration (V2)
-- Run this in your Supabase SQL Editor: https://supabase.com/dashboard/project/ncbmjhqmlxapismaeqdk/sql
-- ==============================================================================

-- ==============================================================================
-- 1. FIX: Permissive RLS Policies on public.complaints (Using 'email')
-- ==============================================================================
...
-- Allow authenticated users to submit complaints matching their registered auth email
...
-- Allow reading complaints (only ticket owner by email or platform admin)
...
-- Allow updating complaints (only ticket owner by email or platform admin)
...
-- ==============================================================================
-- 3. FIX: Revoke Public & Anonymous Execution on SECURITY DEFINER Functions
-- ==============================================================================
